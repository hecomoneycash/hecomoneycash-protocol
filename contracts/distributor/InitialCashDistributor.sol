...
import '../distribution/HMCUSDTPool.sol';
import '../distribution/HMCHETHPool.sol';
import '../distribution/HMCHBTCPool.sol';
import '../distribution/HMCHTPool.sol';
import '../distribution/HMCHRFIPool.sol';
...
contract InitialCashDistributor is IDistributor {
    ...
    constructor(
        ...
        require(_pools.length != 0, 'a list of HMC pools are required');
